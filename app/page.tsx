  ...
  return (
    <main className="min-h-screen bg-black px-6 py-10 text-white">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mx-auto mb-10 flex flex-col max-w-2xl gap-3">
          <button
            onClick={buscarPeliculas}
            className="w-full rounded-xl bg-blue-600 px-6 py-3 font-bold hover:bg-blue-700"
          >
            Buscar
          </button>
          <input
            ...
            className="w-full rounded-xl border border-gray-700 bg-gray-900 px-5 py-3 text-white outline-none focus:border-blue-500"
          />
        </div>
